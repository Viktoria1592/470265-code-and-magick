...
(function () {
  ...
  var generateSimilarWizards = function (wizardsQuantity) {
    ...
    for (var i = 0; i <= wizardsQuantity; i++) {
      var obj = {};
      obj.name = WIZARD_NAMES[window.virtual.getRandomBetween(0, WIZARD_NAMES.length - 1)] + ' ' + WIZARD_SURNAMES[window.virtual.getRandomBetween(0, WIZARD_SURNAMES.length - 1)];
      obj.coatColor = WIZARD_COAT_COLORS[window.virtual.getRandomBetween(0, WIZARD_COAT_COLORS.length - 1)];
      obj.eyesColor = WIZARD_EYES_COLORS[window.virtual.getRandomBetween(0, WIZARD_EYES_COLORS.length - 1)];
      arr.push(obj);
    }
    return arr;
  };
